...
enum enemyType {
	...
	RIFLEMAN_NORMAL, RIFLEMAN_BUSH, WALLTURRET, CANNON, BOSS_TURRET, RIFLEMAN_BOSS, BOSS_CORE,
	LEVEL2_TURRET, LEVEL2_CORE, LEVEL2_SOLDIER, LEVEL2_LASER, LEVEL2_BOSSTURRET, LEVEL2_BOSSCORE, LEVEL2_BOSSFINAL,
	UPGRADE_BOX
};
...
public:
	...
	bool collisionMoveDownSoldier(const glm::ivec2 &pos, const glm::ivec2 &size, int *posY) const;
