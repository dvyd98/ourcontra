...
enum PlayerAnims
{
	STAND_LEFT, STAND_RIGHT, MOVE_LEFT, MOVE_RIGHT, AIM_UP_LOOK_LEFT, AIM_UP_LOOK_RIGHT, CROUCH_LOOK_LEFT, CROUCH_LOOK_RIGHT, AIM_DOWN, AIM_UP_WALK_RIGHT, AIM_UP_WALK_LEFT, AIM_DOWN_WALK_RIGHT, AIM_DOWN_WALK_LEFT
};
...
void Player::update(int deltaTime)
{
	...
	{
		if (sprite->animation() != AIM_UP_WALK_RIGHT)
	...
	{
		if (sprite->animation() != AIM_DOWN_WALK_RIGHT)
